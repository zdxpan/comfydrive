...
def main():
    ...
    with torch.inference_mode():
        ...
        previewaudio = NODE_CLASS_MAPPINGS["PreviewAudio"]()

        for q in range(1):
            cosyvoicenode_12 = cosyvoicenode.generate(
            ...
            previewaudio_3 = previewaudio.save_audio(
                audio=get_value_at_index(cosyvoicenode_12, 0)
            )
