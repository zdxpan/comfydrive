...
def main():
    ...
    with torch.inference_mode():
        ...
        loadimage_228 = loadimage.load_image(image="1 (8).jpg")
        ...
        resizemask_433 = resizemask.resize(
            ...
            keep_proportions=False, upscale_method="nearest-exact",
            crop="disabled",
            mask=get_value_at_index(loadimagemask_432, 0),
        )
        
        growmaskwithblur_337 = growmaskwithblur.expand_mask(
            expand=15, incremental_expandrate=0, tapered_corners=True,
            flip_input=False, blur_radius=10, lerp_alpha=1,
        ...
        layerutility_imagescalebyaspectratio_v2_267 = (
            layerutility_imagescalebyaspectratio_v2.image_scale_by_aspect_ratio(
                ...
                fit="crop", method="lanczos", round_to_multiple="8", scale_to_side="longest",
        ...
        layerutility_imagemaskscaleas_268 = (
            layerutility_imagemaskscaleas.image_mask_scale_as(
                ...
                scale_as=get_value_at_index(layerutility_imagescalebyaspectratio_v2_267, 0),
        ...
        layermask_birefnetultrav2_271 = layermask_birefnetultrav2.birefnet_ultra_v2(
            ...
            black_point=0.01, white_point=0.99, process_detail=True, device="cuda",
            max_megapixels=2,
        ...
        masks_add_570 = masks_add.add_masks(
            masks_a=get_value_at_index(layerutility_imagescalebyaspectratio_v2_267, 1),
            masks_b=get_value_at_index(growmaskwithblur_569, 1),
        )
        ...
        layerutility_imagescalebyaspectratio_v2_557 = (
            layerutility_imagescalebyaspectratio_v2.image_scale_by_aspect_ratio(
                ...
                mask=get_value_at_index(masks_add_570, 0),
            )
        )
        ...
        display_int_rgthree = NODE_CLASS_MAPPINGS["Display Int (rgthree)"]()
        ...
        for q in range(1):
            ...
            imagescale_437 = imagescale.upscale(upscale_method="bicubic",
            ...
            growmask_444 = growmask.expand_mask(
                expand=15,tapered_corners=True,
                mask=get_value_at_index(loadimagemask_432, 0),
            )
            ...
            display_int_rgthree_489 = display_int_rgthree.main(
                input=get_value_at_index(layerutility_getimagesize_321, 0)
            )

            display_int_rgthree_490 = display_int_rgthree.main(
                input=get_value_at_index(layerutility_getimagesize_321, 1)
            )

            display_int_rgthree_493 = display_int_rgthree.main(
                input=get_value_at_index(layerutility_imagescalebyaspectratio_v2_267, 3)
            )

            display_int_rgthree_494 = display_int_rgthree.main(
                input=get_value_at_index(layerutility_imagescalebyaspectratio_v2_267, 4)
            )

            image_comparer_rgthree_503 = image_comparer_rgthree.compare_images(
                image_a=get_value_at_index(imagecompositemasked_439, 0),
                image_b=get_value_at_index(imagecompositemasked_442, 0),
            )

            image_comparer_rgthree_504 = image_comparer_rgthree.compare_images(
                image_a=get_value_at_index(imagecompositemasked_439, 0)
            )
